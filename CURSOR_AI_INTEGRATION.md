...
3. **Generate test content**:
   - Select a template → Click "Send Context to AI"
   - Select a section → Click "Send Listing to AI"
   - Use Stats webview → Click "Send to AI"
